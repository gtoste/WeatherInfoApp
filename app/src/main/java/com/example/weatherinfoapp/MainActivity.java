...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.changeView).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, MainLocationActivity.class);
    ...
    {
        EditText et = (EditText)findViewById(R.id.etCity);
        String name = et.getText().toString();


        Call<OpenWeatherApp> getCityInfo = apiInterface.getWeatherWithName(name);
